...
def catch_errors(exception_type: type[Exception], error_message: str) -> Callable[[Callable[P, T]], Callable[P, T]]:
...
def catch_errors_async(exception_type: type[Exception], error_message: str) -> Callable[[Callable[P, Awaitable[T]]], Callable[P, Awaitable[T]]]:
