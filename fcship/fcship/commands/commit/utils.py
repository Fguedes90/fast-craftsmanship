...
class GitCommands:
    ...
    def detect_renames_with_similarity() -> Dict[str, str]:
        ...
        try:
            ...
            stdout, _ = GitCommands.run_git_command(
                ["git", "diff", "--find-renames=90%", "--name-status"],
                check=False
            )
    ...
    def get_status() -> GitStatus:
        ...
        for line in stdout.splitlines():
            ...
            elif index_status == "D" or work_tree_status == "D" and file_info not in renames.values():
