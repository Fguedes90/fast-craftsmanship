...
def test_get_workflow_logs_success(mock_github):
    ...
    mock_requester.requestBlobAndCheck.assert_called_once_with("GET", "https://api.github.com/repos/user/repo/actions/runs/12345/logs")
...
def test_extract_failed_step_logs(mock_extract):
    ...
    mock_extract.return_value = {
        "Job: build > Step: Build project": "Error log content"
    }
